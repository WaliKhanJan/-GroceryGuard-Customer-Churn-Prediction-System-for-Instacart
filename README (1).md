...
A customer is defined as **churned** if their last recorded gap between orders is **≥ 28 days**.

**Why 28 days?**
- The dataset caps `days_since_prior_order` at 30, making anything above that unobservable
- 28 days = 4 missed weekly cycles for the most common shopper type
- Aligns with the natural "one month" business unit
- The dataset's 75th percentile gap is 15 days — 28 days is statistically unusual for virtually all customer types
...
```
churn_window_days = 28 − median_days_between
```
